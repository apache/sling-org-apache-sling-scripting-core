...
public class SlingBindingsVariablesListJsonServlet extends SlingSafeMethodsServlet implements OptingServlet {
    ...
    public boolean accepts(@NotNull SlingHttpServletRequest request) {
        // only accept if the nonce request parameter matches a value that
        // was previously generated by the ScriptingVariablesConsolePlugin
        return ScriptingVariablesNonceFactory.isValid(request.getParameter("nonce"));
    }
}
