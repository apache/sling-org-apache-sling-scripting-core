...
public class SlingBindingsVariablesListJsonServlet extends SlingSafeMethodsServlet implements OptingServlet {
    ...
    public boolean accepts(@NotNull SlingHttpServletRequest request) {
        ...
        // only accept if the token request parameter matches what is expected
        try {
            String token = request.getParameter("t");
            String expectedHash = request.getParameter("h");
            accept = ScriptingVariablesTokenFactory.isValid(token, expectedHash);
