...
public class HtmlScriptingIT extends ScriptingCoreTestSupport {
    ...
    private static ModifiableCompositeOption slingDiscoveryStandalone() {
        return composite(
                ...
                mavenBundle()
                        .groupId("org.apache.sling")
                        .artifactId("org.apache.sling.discovery.standalone")
                        .version("1.0.2"));
    }
    ...
    private static ModifiableCompositeOption slingModels() {
        return composite(
                ...
                mavenBundle()
                        ...
                        .artifactId("org.apache.servicemix.specs.annotation-api-1.3")
                        .version("1.3_3"));
    }
    ...
    private static ModifiableCompositeOption slingJcr() {
        return composite(
                ...
                factoryConfiguration("org.apache.sling.serviceusermapping.impl.ServiceUserMapperImpl.amended")
                        .put(
                                "user.mapping",
                                new String[] {"org.apache.sling.jcr.contentloader=[sling-jcr-contentloader]"})
                        .asOption());
    }
    ...
    private static ModifiableCompositeOption slingScriptingHtl() {
        return composite(
                ...
                mavenBundle()
                        ...
                        .version("1.4.26-1.4.0"),
                mavenBundle()
                        .groupId("org.apache.sling")
                        .artifactId("org.apache.sling.scripting.sightly.runtime")
                        .version("1.2.6-1.4.0"),
                mavenBundle()
                        .groupId("org.apache.sling")
                        .artifactId("org.apache.sling.scripting.sightly.compiler")
                        .version("1.2.14-1.4.0"),
                mavenBundle()
                        .groupId("org.apache.sling")
                        .artifactId("org.apache.sling.scripting.sightly.compiler.java")
                        .version("1.2.2-1.4.0"),
                mavenBundle()
                        .groupId("org.apache.sling")
                ...
                factoryConfiguration("org.apache.sling.serviceusermapping.impl.ServiceUserMapperImpl.amended")
                        .put(
                                "user.mapping",
                                new String[] {"org.apache.sling.scripting.sightly.js.provider=[sling-scripting]"})
                        .asOption());
    }
    ...
    private static ModifiableCompositeOption slingScriptingThymeleaf() {
        return composite(
                ...
                mavenBundle()
                        .groupId("org.apache.sling")
                        .artifactId("org.apache.sling.scripting.thymeleaf")
                        .version("2.0.2"),
                mavenBundle()
                        .groupId("org.apache.servicemix.bundles")
                        .artifactId("org.apache.servicemix.bundles.thymeleaf")
                        .version("3.0.12.RELEASE_1"),
                ...
                mavenBundle()
                        .groupId("org.apache.servicemix.bundles")
                        .artifactId("org.apache.servicemix.bundles.ognl")
                        .version("3.2.1_1"),
    ...
    private static ModifiableCompositeOption jackrabbit() {
        return composite(
                ...
                mavenBundle()
                        .groupId("org.apache.geronimo.specs")
                        .artifactId("geronimo-el_2.2_spec")
                        .version("1.1"),
                mavenBundle()
                        .groupId("org.apache.geronimo.specs")
                        .artifactId("geronimo-interceptor_1.1_spec")
                        .version("1.0"),
                mavenBundle()
                        .groupId("org.apache.geronimo.specs")
                        .artifactId("geronimo-jcdi_1.0_spec")
                        .version("1.1"),
                mavenBundle()
                        .groupId("org.apache.geronimo.specs")
    ...
    private static ModifiableCompositeOption jackrabbitOak() {
        return composite(
                ...
                mavenBundle()
                        .groupId("org.apache.jackrabbit")
                        .artifactId("oak-query-spi")
                        .version("1.48.0"),
                mavenBundle()
                        .groupId("org.apache.jackrabbit")
                        .artifactId("oak-security-spi")
                        .version("1.48.0"),
                mavenBundle()
                        .groupId("org.apache.jackrabbit")
                        .artifactId("oak-store-composite")
                        .version("1.48.0"),
                mavenBundle()
                        .groupId("org.apache.jackrabbit")
    ...
    private static ModifiableCompositeOption slingQuickstartOak() {
        return composite(
                ...
                newConfiguration("org.apache.jackrabbit.oak.spi.security.user.action.DefaultAuthorizableActionProvider")
                        .put(
                                "enabledActions",
                                new String[] {"org.apache.jackrabbit.oak.spi.security.user.action.AccessControlAction"})
